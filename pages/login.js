...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-800 via-blue-600 to-blue-400">
      <Head>
        <title>Prompt Finder - Login</title>
        ...
        <div className="w-3/4 lg:w-1/2 xl:w-1/3 p-8 rounded-lg shadow-lg bg-white text-center transition-all duration-300 ease-in-out transform hover:scale-105">
          ...
          <div className="px-6">
            <button
              ...
              type="button"
              className="text-white w-full bg-[#5865F2] hover:bg-[#5865F2]/90 focus:ring-4 focus:outline-none focus:ring-[#5865F2]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#5865F2]/55 mr-2 mb-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
